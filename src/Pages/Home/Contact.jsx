...
const Contact = () => {
    ...
    const handleSubmit = event =>{
        ...
        emailjs.sendForm('service_pupaokn', 'template_011s7bc', form.current, 'rbUxJM7fBWoMARGKc')
      .then((result) => {
    ...
    return (
        <section className="min-h-screen bg-gradient-to-r from-gray-600 via-gray-700 to-gray-800">
                ...
                <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                    ...
                    <form ref={form} onSubmit={handleSubmit} className="mt-4">
                        ...
                        <div className="flex-1 mt-6">
                            ...
                            <input name="from_email" type="email" placeholder="johndoe@example.com" className="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                        </div>
